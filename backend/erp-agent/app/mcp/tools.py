...
list_suppliers      GET     /api/v1/suppliers                     ?skip=, ?limit=                    [{id, code, name,
                                                                                                      default_lead_time_days,
                                                                                                      rating, is_active}]
                    GET     /api/v1/suppliers/{supplier_id}       path: supplier_id                  {id, code, name,
                                                                                                      default_lead_time_days,
                                                                                                      rating, is_active}
...
from app.mcp.server import get, post
